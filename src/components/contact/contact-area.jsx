                ...
                <div className="tp-contact-info-wrapper">
                  <div className="tp-contact-info-item">
                    ...
                    <div className="tp-contact-info-content">
                      <p data-info="mail">
                        <a href="mailto:contact@medicast.tn">contact@medicast.tn</a>
                      </p>
                      <p data-info="phone">
                        <a href="tel:71123456">+216 71 123 456</a>
                      </p>
                    </div>
                  </div>
                  <div className="tp-contact-info-item">
                    ...
                    <div className="tp-contact-info-content">
                      <p>
                        <a
                          href="https://www.google.com/maps?q=36.857917,10.207750&hl=fr&z=15"
                          target="_blank"
                        >
                          ZI Sidi Rézig, <br /> Ben Arous, Tunisie
                        </a>
                      </p>
                    </div>
                  </div>
